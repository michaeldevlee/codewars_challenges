...
with dreadful weather and not much water, it's important to save yourself some energy, 
...
immediately "SOUTH" is not reasonable, better 
stay to the same place! So the task is to give to the 
...
direction "NORTH" + "SOUTH" is going north and coming back right away.
...
function dirReduc(arr){
  // solving using stack (similar to valid parenthesis)
  let stack = [];
...
function dirReduc(plan) {
  ...
  return plan.reduce(function(dirs, dir){ // reduced it to an array!
